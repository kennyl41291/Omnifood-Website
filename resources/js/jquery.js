...
//  element: document.getElementByClass('js--section-features'),
...
//    Navigation mobile
    $('.js--nav-icon').click(function() {
        var nav = $('.js--main-nav');
        nav.slideToggle(300)
        var icon1 = $('.js--nav-icon ion-icon:first-of-type');
        var icon2 = $('.js--nav-icon ion-icon:last-of-type');
        icon1.toggle(0, function() {
                     icon2.toggleClass('appear');;
                     });
    
//        var iconClass = icon.attr('name',"")
//        
//        icon.attr("name", "ios-arrow-down");
